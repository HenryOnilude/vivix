...
**Tech:** Svelte 5, Acorn parser, custom AST interpreter (no eval), CodeMirror 6, 161 unit tests.
...
**161 tests**, mobile responsive, shareable URLs, accessibility themes.
...
9 modules covering core JS concepts (variables through closures), each with a purpose-built visualization. Svelte 5, CodeMirror 6, 161 tests.
