...
<style>
  ...
  .cpu-explain { padding:6px 12px; font-size:0.68rem; color:#c0c0c0; line-height:1.6; border-top:1px solid #1a1a2e; white-space:pre-wrap; font-family:'SF Mono','Fira Code',monospace; }
</style>
